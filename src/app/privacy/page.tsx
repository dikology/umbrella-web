      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <article className="prose prose-lg prose-slate max-w-none">
          ...
          <section>
            ...
            <table className="min-w-full border border-[--color-border] my-4">
              <thead className="bg-[--color-surface]">
                <tr>
                  <th className="border border-[--color-border] px-4 py-2 text-left">Data Type</th>
                  <th className="border border-[--color-border] px-4 py-2 text-left">Retention Period</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-[--color-border] px-4 py-2">Email (signup)</td>
                  <td className="border border-[--color-border] px-4 py-2">Until unsubscribe or 2 years</td>
                </tr>
                <tr>
                  <td className="border border-[--color-border] px-4 py-2">Analytics</td>
                  <td className="border border-[--color-border] px-4 py-2">90 days</td>
                </tr>
                <tr>
                  <td className="border border-[--color-border] px-4 py-2">TestFlight Feedback</td>
                  <td className="border border-[--color-border] px-4 py-2">1 year</td>
                </tr>
              </tbody>
            </table>
          </section>
          ...
          <section>
            ...
            <p>Email: <a href="mailto:privacy@umbrella-app.com" className="text-[--color-primary]">privacy@umbrella-app.com</a></p>
