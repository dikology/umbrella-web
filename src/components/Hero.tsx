  ...
  return (
    <section id="hero" className="relative min-h-screen bg-gradient-to-br from-teal-50 via-slate-50 to-white flex items-center justify-center pt-16">
      <div className="max-w-4xl mx-auto px-4 text-center">
        {/* Main Headline */}
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-[--color-text] leading-tight mb-6">
        ...
        {/* Subtitle */}
        <p className="text-xl md:text-2xl text-[--color-text-secondary] mb-12 max-w-3xl mx-auto leading-relaxed">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-[--color-primary]/5 rounded-full blur-3xl"></div>
