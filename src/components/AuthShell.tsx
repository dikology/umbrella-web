...
export default function AuthShell({ title, children, footer }: AuthShellProps) {
  return (
    <main className="min-h-screen bg-paper-100 flex flex-col items-center px-4 py-12">
      <Link
        href="/"
        className="font-display text-3xl font-semibold text-coral-600 hover:text-coral-700 tracking-tight mb-8 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-coral-500"
      >
        Umbrella
      </Link>
