...
export default function ProblemSolution() {
  return (
    <section id="how-it-works" className="py-16 md:py-24 bg-[--color-surface]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <Card>
            <h3 className="text-xl font-semibold text-[--color-text] mb-3">📚 The Problem</h3>
          ...
          <Card>
            <h3 className="text-xl font-semibold text-[--color-text] mb-3">🔍 The Gap</h3>
            <p className="text-[--color-text-secondary] leading-relaxed">
          ...
          <Card>
            <h3 className="text-xl font-semibold text-[--color-text] mb-3">😩 The Frustration</h3>
            <p className="text-[--color-text-secondary] leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card>
            <h3 className="text-xl font-semibold text-[--color-text] mb-3">✓ Authentic Texts</h3>
            <p className="text-[--color-text-secondary] leading-relaxed">
          ...
          <Card>
            <h3 className="text-xl font-semibold text-[--color-text] mb-3">✓ Your Level Content</h3>
            <p className="text-[--color-text-secondary] leading-relaxed">
          ...
          <Card>
            <h3 className="text-xl font-semibold text-[--color-text] mb-3">✓ Proficiency Tracking</h3>
            <p className="text-[--color-text-secondary] leading-relaxed">
